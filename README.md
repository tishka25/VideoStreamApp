...
In order for the app to work properly it has to run the server backend [repo](https://github.com/tishka25/VideoStreamApp-MediaServer).
After successfuly running the server update the ```.env``` file.
